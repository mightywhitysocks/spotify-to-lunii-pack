...
cells = [("Couverture", TREE / "0-item.png"),
         ("Menu « choisis un thème »", MENU / "0-item.png")]
parts = ["<!doctype html><meta charset=utf-8><title>Images du pack Timoté</title>",
         ...
         "<h1>Images du pack « Les histoires de Timoté »</h1>",
...
for cat in sorted(by_cat):
    parts.append(f"<h2>{html.escape(cat[2:])}</h2><div class=g>")
